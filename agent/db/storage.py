...
def store_approved_prompts(
    ...
    """
    Store user-approved prompts to the shared library without images.
    Inserts into generated_ads with status='prompts_approved' and image_url=''.

    Returns:
        {"status": "success", "record_id": "..."}
    """
    client = _get_client()
